...
def is_between_100_and_999(user_input_number):
    ...
    if 100 <= input_number and input_number < 1000:
        result = True
    else:
        result = False
    # ==================================
...
def get_not_duplicated_three_digit_number():
    ...
    while not is_validated_number(str(user_input_number)):
        user_input_number = get_random_number()
...
def main():
    ...
    while True:
        ...
        if is_validated_number(user_input_number):
            strike, ball = get_strikes_or_ball(user_input_number, random_number)
